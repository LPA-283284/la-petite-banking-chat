...
with st.form("banking_form"):
    ...
    gross_total = st.number_input("Gross (£)", min_value=0.0, format="%.2f", value=None, key="gross_total")
    net_total = st.number_input("Net (£)", min_value=0.0, format="%.2f", value=None, key="net_total")
    service_charge = st.number_input("Service Charge (£)", min_value=0.0, format="%.2f", value=None, key="service_charge")
    discount_total = st.number_input("Discount (£)", min_value=0.0, format="%.2f", value=None, key="discount_total")
    complimentary_total = st.number_input("Complimentary (£)", min_value=0.0, format="%.2f", value=None, key="complimentary_total")
    staff_food = st.number_input("Staff Food (£)", min_value=0.0, format="%.2f", value=None, key="staff_food")
    ...
    tips_sc = st.number_input("Servis Charge (£)", min_value=0.0, format="%.2f", value=None, key="tips_credit_card")
    tips_credit_card = st.number_input("CC Tips (£)", min_value=0.0, format="%.2f", value=None, key="tips_sc")
