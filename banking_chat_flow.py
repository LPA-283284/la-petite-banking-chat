...
deposit = st.number_input("Kapora / Deposit (£)", min_value=0.0, format="%.2f", key="deposit1")
deposit = st.number_input("Kapora / Deposit (£)", min_value=0.0, format="%.2f", key="deposit2")
