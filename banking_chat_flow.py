...
deposit_plus = st.number_input("Deposit ( + ) (£)", min_value=0.0, format="%.2f", value=0.0e, placeholder="0.00", key="deposit_plus")
tips_credit_card = st.number_input("Tips (CC) (£)", min_value=0.0, format="%.2f", value=0.0, placeholder="0.00", key="tips_credit_card")
tips_sc = st.number_input("Service Charge (Tips) (£)", min_value=0.0, format="%.2f", value=0.0, placeholder="0.00", key="tips_sc")
cash_envelope = st.number_input("Cash in Envelope (£)", min_value=0.0, format="%.2f", value=0.0, placeholder="0.00", key="cash_envelope")
float_val = st.number_input("Float (£)", min_value=75.0, format="%.2f", value=75.0, placeholder="0.00", key="float_val")
